                                ...
                                <div class="profile-container">
                                    <div class="profile-info">
                                        <div class="row valign-wrapper">
                                            ...
                                            <div class="col m1 offset-m1 <?php if ($curId != $sessionId || $isEdit) echo "hide" ?>">
                                            ...
                                            <div class="col m1 offset-m1 <?php if (!$isEdit) echo "hide" ?>">
                                                ...
                                                <div class="col m12">
                                                    <a href="index.php?id=<?= $sessionId ?>" class="waves-effect waves-light btn white-text valign right tooltipped" data-tooltip="Batal" tabindex="8"><i class="material-icons">cancel</i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
						...
						<div class="card">
							<div class="card-content">
								<div class="row">
									...
									<div class="input-field col m6 hide">
